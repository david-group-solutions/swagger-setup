...
namespace DavidGroup.Core.SwaggerSetup.Attributes;
...
/// </remarks>
internal class SwaggerControllerOrder
{
    private readonly Dictionary<string, uint> _orders;

    /// <summary>
    /// Initializes a new instance of <see cref="SwaggerControllerOrder"/> by scanning an assembly for controllers.
    /// </summary>
    /// <param name="assembly">The <see cref="Assembly"/> to scan for controllers.</param>
    public SwaggerControllerOrder(Assembly assembly)
        : this(GetFromAssembly(assembly)) { }

    /// <summary>
    /// Initializes a new instance of <see cref="SwaggerControllerOrder"/> using a collection of controller types.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves all types assignable to the <see cref="ControllerBase"/> from the given assembly.
    /// </summary>
    /// <param name="assembly">The <see cref="Assembly"/> to scan.</param>
    private static IEnumerable<Type> GetFromAssembly(Assembly assembly)
    {
        return assembly.GetTypes().Where(c => typeof(ControllerBase).IsAssignableFrom(c));
    }
